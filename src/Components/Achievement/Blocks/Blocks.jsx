...
function Blocks() {
  return (
    <div className="Blocks">
      <div className="Blocks_item_1" data-aos="fade-up-left" data-aos-duration="1000" data-aos-easing="ease-in-out">
        <div className="Blocks_item Blocks_item-1">
      ...
      <div className="Blocks_item_2" data-aos="fade-up-left" data-aos-duration="1000" data-aos-easing="ease-in-out">
      ...
      <div className="Blocks_item_3" data-aos="fade-up-left" data-aos-duration="1000" data-aos-easing="ease-in-out">
        <div className="Blocks_item">
          <div className="Blocks_item_info">
