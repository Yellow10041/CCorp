    ...
    <div className="Header">
        ...
        <div className="Header_nav">
            <nav className='Header_nav_items'>
                <div className="Header_nav_item">Activities</div>
                <div className="Header_nav_item">Technology</div>
                <div className="Header_nav_item">R&D</div>
                <div className="Header_nav_item">Community</div>
            </nav>
